...
const GROUP_DEFINITION: &str = "matter_movement=movement_propose+movement_commit+material_flag_hygiene_movement+environment_reconcile_movement+phase_energy_reconcile_movement;ownership_claim=movement_claim+expansion_claim+expansion_environment_receiver_claim+smoke_claim+smoke_environment_receiver_claim;thermal_conduction=air_flow_scale+air_transport_commit+thermal_stability_scale+unified_thermal_commit+phase_context_propose;reaction_phase=phase_thermodynamics+expansion_spawn_commit+expansion_pressure+material_flag_hygiene_phase+environment_reconcile_expansion+decay+material_flag_hygiene_decay+phase_energy_hygiene_decay+environment_reconcile_decay+ignition_exposure_propose+combustion+smoke_commit+material_flag_hygiene_combustion+phase_energy_hygiene_combustion+environment_reconcile_smoke;pressure_structure=environment_blocked_expansion_pressure+pressure+rupture+material_flag_hygiene_rupture+phase_energy_hygiene_rupture+environment_reconcile_rupture;active_sleep_management=activity_wake+activity_propose+phase_activity_propose+environment_activity_propose+ignition_activity_propose+pressure_activity_propose+activity_reduce";
...
mod tests {
    ...
    fn aggregate_writer_emits_precomputed_per_tick_group_percentile() {
        ...
        assert_eq!(raw_row[final_index], "9500");
