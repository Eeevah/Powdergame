...
| [`docs/architecture/decisions/ADR-0012-ignition-exposure-dose.md`](../docs/architecture/decisions/ADR-0012-ignition-exposure-dose.md) | Proposed TE-4D dose/chemical-heat model and frozen reference blocker | Before revising ignition kinetics or authorizing TE-4 runtime |
| [`docs/specs/IGNITION_KINETICS_SPEC.md`](../docs/specs/IGNITION_KINETICS_SPEC.md) | Proposed exposure, flame, cooling, chemical-Q and ownership invariants | Before any TE-4 implementation design |
| [`docs/development/IGNITION_KINETICS_VALIDATION.md`](../docs/development/IGNITION_KINETICS_VALIDATION.md) | TE4-F01–F17 and immutable D-028 one-shot failure receipt | Before any new TE-4 evidence identity |
