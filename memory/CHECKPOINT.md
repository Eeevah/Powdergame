...
Edit-core source `f9a7087...` passed the Windows unit suite (`149 passed`, `1 ignored`) and exact shared scenario reset. Launch source `0d03daf...` passed default/explicit-route tests, affected check/clippy, strict launcher/policy audit, and one no-mode release 3-frame Sandbox bounded launch check on RTX 5090/DX12. This is implementation integrity, not user acceptance.
...
- Canonical no-mode bounded launch check — `target/release/powdergame-windows.exe`, SHA-256 `9e809342074c313c79a1080a89b9aa6e84e0e39238b4c8d9aa1368ad8bc72f3c`, 3 frames, exit `0`; valid only as startup/default-routing evidence for source `0d03daf...`, not UX approval and not Smoke Matter validation.
...
- D-010 — canonical no-argument BAT/EXE launch opens the G9-A Sandbox; Gallery is explicit.
