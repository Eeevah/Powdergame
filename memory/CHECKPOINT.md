...
Source `f9a7087...` passed the Windows unit suite (`149 passed`, `1 ignored`), exact shared scenario reset, affected check/clippy, strict launcher/policy audit, and one release 3-frame Sandbox smoke on RTX 5090/DX12. This is implementation integrity, not user acceptance.
...
- Canonical smoke — `target/release/powdergame-windows.exe`, SHA-256 `a6854f4de191877d74203569dd72d99db93d533a1359fb190a27209552a23772`, 3 frames, exit `0`; valid only as startup evidence for the same source/build environment, not UX approval.
